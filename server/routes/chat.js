...
router.post('/getChat', authMiddleware.auth, chatController.getChat);
// Send a message
router.post('/sendMessage', authMiddleware.auth, chatController.sendMessage);
// Get messages for a chat
//router.get('/getMessages', authMiddleware.auth, chatController.getMessages);
router.post('/getMessages', authMiddleware.auth, chatController.getMessages);  // Change GET to POST
